...
import kotlinx.android.synthetic.main.fragment_they_owe_me.*
...
class TheyOweMeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_they_owe_me, container, false)
    }
    ...
    private fun getMockStats(): List<DataIC> {
        ...
        for (i in range){
            if (list[i].variable == getString(R.string.they_owe_me)) outList.add(list[i])
        }
        return outList
    }
}
